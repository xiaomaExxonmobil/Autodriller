...
df = spark.table('sandbox.auto_driller_1s_silver_test').filter(col('well_name')=='Keydets-A 47 #4H')
...
exportDFToSQLDB(df, 'auto_driller_1s')

# COMMAND ----------

exportToSQLDB('sandbox.auto_driller_1s_silver_test', 'auto_driller_1s')

# COMMAND ----------

df_health = spark.table('sandbox.auto_driller_mvp_health_test')

# COMMAND ----------

df_health.select('well_name').distinct().show()

# COMMAND ----------

exportToSQLDB('sandbox.auto_driller_mvp_health_test', 'auto_driller_mvp_fools_gold')
